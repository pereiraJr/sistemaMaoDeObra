		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">ID Anuncio</a>	</th>
				...
				<tr>
					...
					<a
                        href="AnuncioController.do?action=editar&anuncioId=<c:out value="${anuncio.anuncioId  }"/>"title="Editar" class="icon-1 info-tooltip"></a>
